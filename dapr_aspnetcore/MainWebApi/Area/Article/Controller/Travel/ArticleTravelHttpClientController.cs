...
namespace MainWebApi.Area.Article.Controller.Travel
{
    [Area("Article-Travel")]
    [Route("[area]/[controller]")]
    [ApiController]
    public class ArticleTravelHttpClientController : ControllerBase
    {
        private readonly ILogger<ArticleTravelHttpClientController> log;
        private readonly AppServicesName AppServicesName;

        public ArticleTravelHttpClientController(
            ILogger<ArticleTravelHttpClientController> logger,
