...
namespace News.Web.Api.Area.Activity.Controllers
{
    ...
    [ApiController]
    public class ActivityNewsEventController : ControllerBase
    {
        private readonly ILogger<ActivityNewsEventController> log;
        private readonly IStateStoreEvent daprStateStore;

        public ActivityNewsEventController(
            ILogger<ActivityNewsEventController> logger,
